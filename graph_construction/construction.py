...
subset = ['ITUB4', 'LUPA3', 'M1TA34', 'ORCL34', 'HYPE3', 'GOGL35',
          'FLRY3', 'EGIE3', 'DMVF3', 'COCA34', 'BHIA3', 'AERI3', 'PETR4']
assert len(subset) == len([node for node in subset if node in nodes]), (
    'The subset contains nodes that are not in the graph'
)
g2 = Graph(subset)
